...
import { findNodeHandle, View, FlatList, Text, Animated, Easing, Dimensions, Platform, StatusBar, Keyboard, Linking, Image, TouchableOpacity, Modal, SafeAreaView, ActivityIndicator } from 'react-native';
...
var AvatarContainer = styled.View(_templateObject(), function (_ref) {
...
function (_PureComponent) {
  ...
  return Chat;
}(PureComponent), _defineProperty(_class$1, "themePath", ''), _defineProperty(_class$1, "propTypes", {
...
var Wrapper = styled.TouchableOpacity(_templateObject$1(), function (_ref) {
...
var Container = styled.View(_templateObject2$1(), function (_ref3) {
...
var Title = styled.Text(_templateObject3$1(), function (_ref7) {
...
var Separator = styled.View(_templateObject4$1(), function (_ref9) {
  var theme = _ref9.theme;
  return theme.messageInput.suggestions.separator.css;
});
var SuggestionsItem = styled.TouchableOpacity(_templateObject5(), function (_ref10) {
  var theme = _ref10.theme;
  return theme.messageInput.suggestions.container.itemHeight;
}, function (_ref11) {
  var theme = _ref11.theme;
...
var Container$1 = styled.View(_templateObject$2(), function (_ref) {
  var theme = _ref.theme;
  return theme.messageInput.suggestions.mention.container.css;
});
var Name = styled.Text(_templateObject2$2(), function (_ref2) {
  var theme = _ref2.theme;
...
var Container$2 = styled.View(_templateObject$3(), function (_ref) {
  var theme = _ref.theme;
  return theme.messageInput.suggestions.command.container.css;
});
var Top = styled.View(_templateObject2$3(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.messageInput.suggestions.command.top.css;
});
var Title$1 = styled.Text(_templateObject3$2(), function (_ref3) {
...
function (_React$Component) {
  ...
  _createClass(CommandsItem, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(Container$2, null, React__default.createElement(Top, null, React__default.createElement(Title$1, null, "/", name, " "), React__default.createElement(Text, null, args)), React__default.createElement(Text, null, description));
    }
  }]);
...
var withTranslationAndStatics = function withTranslationAndStatics(ns) {
  ...
  return function (component) {
    return hoistStatics(withTranslation(ns, _objectSpread$1({
      withRef: true
...
var Circle = styled(AnimatedView)(_templateObject$4(), function (_ref) {
  var theme = _ref.theme;
  return theme.colors.primary;
}, function (_ref2) {
  var theme = _ref2.theme;
...
var LoadingText = styled.Text(_templateObject$5());
...
var LoadingErrorIndicator = function LoadingErrorIndicator(_ref) {
  ...
  switch (listType) {
    case 'channel':
      Loader = React__default.createElement(Text, null, t('chat.error.loadingError.channel'));
      break;

    case 'message':
      Loader = React__default.createElement(Text, null, t('chat.error.loadingError.message'));
      break;

    default:
      Loader = React__default.createElement(Text, null, t('chat.error.loadingError.default'));
      break;
  }
...
var EmptyStateIndicator = function EmptyStateIndicator(_ref) {
  ...
  switch (listType) {
    case 'channel':
      Indicator = React__default.createElement(Text, null, t('chat.channel.noChannels'));
      break;
    ...
    default:
      Indicator = React__default.createElement(Text, null, t('chat.channel.noItems'));
      break;
  }
  ...
  _createClass(ChannelInner, [{
    ...
    value: function render() {
      ...
      if (this.state.error) {
        ...
        core = React__default.createElement(View, null, React__default.createElement(Text, null, this.props.t('chat.channel.missing')));
      } else {
...
function (_PureComponent) {
  ...
  _createClass(Channel, [{
    ...
    value: function render() {
      if (!this.props.channel.cid) {
        return React__default.createElement(Text, null, this.props.t('chat.channel.noChannelSelected'));
      }
  ...
  return Channel;
}(PureComponent), _defineProperty(_class$6, "propTypes", {
  /** Which channel to connect to */
  channel: PropTypes.shape({
    watch: PropTypes.func
  }).isRequired,
...
var Container$3 = styled.TouchableOpacity(_templateObject$6(), function (_ref) {
...
var Footer = styled.View(_templateObject2$4(), function (_ref5) {
  var theme = _ref5.theme;
  return theme.message.card.footer.css;
});
var Cover = styled.Image(_templateObject3$3(), function (_ref6) {
  var theme = _ref6.theme;
...
var GalleryContainer = styled.View(_templateObject2$6(), function (_ref5) {
  var theme = _ref5.theme;
  return theme.message.gallery.width;
}, function (_ref6) {
  var theme = _ref6.theme,
...
var ImageContainer = styled.TouchableOpacity(_templateObject3$5(), function (_ref10) {
  var theme = _ref10.theme,
...
var HeaderContainer = styled.View(_templateObject4$2(), function (_ref13) {
  var theme = _ref13.theme;
  return theme.message.gallery.header.container.css;
});
var HeaderButton = styled.TouchableOpacity(_templateObject5$1(), function (_ref14) {
...
var FileDetails = styled.View(_templateObject2$7(), function (_ref5) {
  var theme = _ref5.theme;
  return theme.message.file.details.css;
});
var FileTitle = styled.Text(_templateObject3$6(), function (_ref6) {
  var theme = _ref6.theme;
  return theme.message.file.title.css;
});
var FileSize = styled.Text(_templateObject4$3(), function (_ref7) {
  var theme = _ref7.theme;
...
var Spacer = styled.View(_templateObject$b());
var StatusContainer = styled.View(_templateObject2$8());
var DeliveredContainer = styled.View(_templateObject3$7(), function (_ref) {
  var theme = _ref.theme;
  return theme.message.status.deliveredContainer.css;
});
var DeliveredCircle = styled.View(_templateObject4$4(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.colors.primary;
}, function (_ref3) {
  var theme = _ref3.theme;
...
var CheckMark = styled.Image(_templateObject5$2(), function (_ref4) {
  var theme = _ref4.theme;
  return theme.message.status.checkMark.css;
});
var SendingContainer = styled.View(_templateObject6(), function (_ref5) {
  var theme = _ref5.theme;
  return theme.message.status.sendingContainer.css;
});
var SendingImage = styled.View(_templateObject7(), function (_ref6) {
  var theme = _ref6.theme;
  return theme.message.status.sendingImage.css;
});
var ReadByContainer = styled.View(_templateObject8(), function (_ref7) {
  var theme = _ref7.theme;
...
var TouchableWrapper = styled.TouchableOpacity(_templateObject$c(), function (props) {
  return props.position === 'left' ? 'left: -10px;' : 'right: -10px;';
});
var Container$6 = styled.View(_templateObject2$9(), function (_ref) {
...
var ImageWrapper = styled.View(_templateObject4$5(), function (_ref6) {
  var visible = _ref6.visible;
  return visible ? 1 : 0;
});
var LeftTail = styled.Image(_templateObject5$3());
var LeftCenter = styled.Image(_templateObject6$1());
var LeftEnd = styled.Image(_templateObject7$1());
var RightTail = styled.Image(_templateObject8$1());
...
var Container$7 = styled.TouchableOpacity(_templateObject$d(), function (_ref) {
...
var ContainerView = styled.View(_templateObject2$a(), function (_ref3) {
  var theme = _ref3.theme;
  return theme.message.reactionPicker.containerView.css;
});
var Column = styled.View(_templateObject3$9(), function (_ref4) {
  var theme = _ref4.theme;
  return theme.message.reactionPicker.column.css;
});
var Emoji = styled.Text(_templateObject4$6(), function (_ref5) {
  var theme = _ref5.theme;
  return theme.message.reactionPicker.emoji.css;
});
var ReactionCount$1 = styled.Text(_templateObject5$4(), function (_ref6) {
  var theme = _ref6.theme;
...
var TextContainer = styled.View(_templateObject$e(), function (_ref) {
  var theme = _ref.theme,
...
var Container$8 = styled.TouchableOpacity(_templateObject$f(), function (_ref) {
  var theme = _ref.theme;
  return theme.message.replies.container.css;
});
var MessageRepliesText = styled.Text(_templateObject2$b(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.colors.primary;
}, function (_ref3) {
  var theme = _ref3.theme;
...
var Container$9 = styled.View(_templateObject$g());
...
var Container$a = styled.TouchableOpacity(_templateObject$h(), function (_ref) {
...
var ContainerInner = styled.View(_templateObject2$c(), function (_ref10) {
...
var MetaContainer = styled.View(_templateObject3$b(), function (_ref12) {
  var theme = _ref12.theme;
  return theme.message.content.metaContainer.css;
});
var MetaText = styled.Text(_templateObject4$7(), function (_ref13) {
  var theme = _ref13.theme;
...
var DeletedContainer = styled.View(_templateObject5$5(), function (_ref16) {
...
var ActionSheetTitleContainer = styled.View(_templateObject8$2(), function (_ref20) {
...
var Container$b = styled.View(_templateObject$i(), function (_ref) {
  var alignment = _ref.alignment;
...
var Spacer$1 = styled.View(_templateObject2$d(), function (_ref4) {
  var theme = _ref4.theme;
...
var Container$c = styled.View(_templateObject$j(), function (_ref) {
  var theme = _ref.theme;
  return theme.messageList.messageSystem.container.css;
});
var Line = styled.View(_templateObject2$e(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.colors.light;
}, function (_ref3) {
  var theme = _ref3.theme;
...
var TextContainer$1 = styled.View(_templateObject3$c(), function (_ref4) {
  var theme = _ref4.theme;
  return theme.messageList.messageSystem.textContainer.css;
});
var Text$1 = styled.Text(_templateObject4$8(), function (_ref5) {
  var theme = _ref5.theme;
  return theme.messageList.messageSystem.text.css;
});
var DateText = styled.Text(_templateObject5$6(), function (_ref6) {
  var theme = _ref6.theme;
...
var MessageSystem = function MessageSystem(_ref7) {
  ...
  return React__default.createElement(Container$c, null, React__default.createElement(Line, null), React__default.createElement(TextContainer$1, null, React__default.createElement(Text$1, null, message.text.toUpperCase()), React__default.createElement(DateText, null, Moment(message.received_at).format('dddd').toUpperCase(), ' ', "at", ' ', Moment(message.received_at).format('hh:mm A').toUpperCase())), React__default.createElement(Line, null));
};
...
var Container$d = styled.View(_templateObject$k(), function (_ref) {
  var alignment = _ref.alignment;
  return alignment === 'left' ? 'flex-start' : 'flex-end';
}, function (_ref2) {
...
var Date$1 = styled.Text(_templateObject$l(), function (_ref) {
  var theme = _ref.theme;
  return theme.messageList.eventIndicator.date.css;
});
var MemberUpdateContainer = styled.View(_templateObject2$f(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.messageList.eventIndicator.memberUpdateContainer.css;
});
var MemberUpdateTextContainer = styled.View(_templateObject3$d(), function (_ref3) {
  var theme = _ref3.theme;
  return theme.messageList.eventIndicator.memberUpdateTextContainer.css;
});
var MemberUpdateText = styled.Text(_templateObject4$9(), function (_ref4) {
  var theme = _ref4.theme;
...
var Container$e = styled.TouchableOpacity(_templateObject$m(), function (_ref) {
  var theme = _ref.theme;
  return theme.colors.primary;
}, function (_ref2) {
  var theme = _ref2.theme;
...
var MessageNotificationText = styled.Text(_templateObject2$g(), function (_ref3) {
  var theme = _ref3.theme;
...
}(PureComponent), _defineProperty(_class$g, "propTypes", {
...
var Line$1 = styled.View(_templateObject2$h(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.colors.light;
}, function (_ref3) {
  var theme = _ref3.theme;
...
var DateText$1 = styled.Text(_templateObject3$e(), function (_ref4) {
  var theme = _ref4.theme;
  return theme.messageList.dateSeparator.dateText.css;
});
var Date$2 = styled.Text(_templateObject4$a(), function (_ref5) {
  var theme = _ref5.theme;
...
var TypingText = styled.Text(_templateObject$o(), function (_ref) {
  var theme = _ref.theme;
...
var Container$g = styled.View(_templateObject2$i());
...
var ListContainer = styled.FlatList(_templateObject$p(), function (_ref) {
  var theme = _ref.theme;
  return theme.messageList.listContainer.css;
});
var ErrorNotificationText = styled.Text(_templateObject2$j(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.messageList.errorNotificationText.css;
});
var ErrorNotification = styled.View(_templateObject3$f(), function (_ref3) {
  var theme = _ref3.theme;
  return theme.messageList.errorNotification.css;
});
var TypingIndicatorContainer = styled.View(_templateObject4$b(), function (_ref4) {
  var theme = _ref4.theme;
...
var Overlay = styled.View(_templateObject$q(), function (_ref) {
  var theme = _ref.theme;
  return theme.messageInput.uploadProgressIndicator.overlay.css;
});
var Container$h = styled.View(_templateObject2$k(), function (_ref2) {
  var theme = _ref2.theme;
...
function (_React$PureComponent) {
  ...
  _createClass(UploadProgressIndicator, [{
    ...
    value: function render() {
      ...
      }, children, React__default.createElement(Overlay, null), React__default.createElement(Container$h, null, type === ProgressIndicatorTypes.IN_PROGRESS && React__default.createElement(View, {
        style: {
          position: 'absolute',
          top: 0,
          left: 0,
...
var Container$i = styled.View(_templateObject$r(), function (_ref) {
  var theme = _ref.theme;
  return theme.messageInput.imageUploadPreview.container.css;
});
var ItemContainer = styled.View(_templateObject2$l(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.messageInput.imageUploadPreview.itemContainer.css;
});
var Dismiss = styled.TouchableOpacity(_templateObject3$g(), function (_ref3) {
  var theme = _ref3.theme;
  return theme.messageInput.imageUploadPreview.dismiss.css;
});
var Upload = styled.Image(_templateObject4$c(), function (_ref4) {
  var theme = _ref4.theme;
  return theme.messageInput.imageUploadPreview.upload.css;
});
var DismissImage = styled.Image(_templateObject5$7(), function (_ref5) {
  var theme = _ref5.theme;
...
function (_React$PureComponent) {
  ...
  _createClass(ImageUploadPreview, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(Container$i, null, React__default.createElement(FlatList, {
        horizontal: true,
        style: {
          flex: 1
        },
...
var Container$j = styled.TouchableOpacity(_templateObject$s(), function (_ref) {
  var theme = _ref.theme;
  return theme.messageInput.sendButton.css;
});
var SendButtonIcon = styled.Image(_templateObject2$m(), function (_ref2) {
  var theme = _ref2.theme;
...
var InputBox = styled.TextInput(_templateObject$t(), function (_ref) {
  var theme = _ref.theme;
...
var Container$k = styled(function (_ref) {
...
var InputBoxContainer = styled.View(_templateObject2$n(), function (_ref4) {
  var theme = _ref4.theme;
  return theme.messageInput.inputBoxContainer.css;
});
var AttachButton = styled.TouchableOpacity(_templateObject3$h(), function (_ref5) {
  var theme = _ref5.theme;
  return theme.messageInput.attachButton.css;
});
var AttachButtonIcon = styled.Image(_templateObject4$d(), function (_ref6) {
  var theme = _ref6.theme;
  return theme.messageInput.attachButtonIcon.css;
});
var ActionSheetTitleContainer$1 = styled.View(_templateObject5$8(), function (_ref7) {
  var theme = _ref7.theme;
  return theme.messageInput.actionSheet.titleContainer.css;
});
var ActionSheetTitleText$1 = styled.Text(_templateObject6$3(), function (_ref8) {
  var theme = _ref8.theme;
  return theme.messageInput.actionSheet.titleText.css;
});
var ActionSheetButtonContainer$1 = styled.View(_templateObject7$3(), function (_ref9) {
  var theme = _ref9.theme;
  return theme.messageInput.actionSheet.buttonContainer.css;
});
var ActionSheetButtonText$1 = styled.Text(_templateObject8$3(), function (_ref10) {
  var theme = _ref10.theme;
...
var Container$l = styled.TouchableOpacity(_templateObject$v(), function (_ref) {
  var theme = _ref.theme;
  return theme.channelPreview.container.css;
});
var Details = styled.View(_templateObject2$o(), function (_ref2) {
  var theme = _ref2.theme;
...
function (_PureComponent) {
  ...
  _createClass(ChannelPreviewMessenger, [{
    ...
    value: function render() {
      ...
      }, !this.props.latestMessage ? this.props.t('chat.channelPreview.emptyChannel') : truncate$1(this.props.latestMessage.text.replace(/\n/g, ' '), 14))));
    }
  }]);
...
function (_PureComponent) {
  ...
  return ChannelList;
}(PureComponent), _defineProperty(_class$s, "propTypes", {
...
var NewThread = styled.View(_templateObject$w(), function (_ref) {
  var theme = _ref.theme;
  return theme.thread.newThread.css;
});
var NewThreadText = styled.Text(_templateObject2$p(), function (_ref2) {
  var theme = _ref2.theme;
...
var Container$m = styled.View(_templateObject$x());
var Icon = styled.View(_templateObject2$q(), function (_ref) {
  var theme = _ref.theme;
...
function (_React$Component) {
  ...
  _createClass(IconBadge, [{
    ...
    value: function render() {
      ...
      return createElement(Container$m, null, children, unread > 0 && createElement(Icon, null, createElement(IconInner, null, showNumber && createElement(UnreadCount, null, unread))));
    }
  }]);
